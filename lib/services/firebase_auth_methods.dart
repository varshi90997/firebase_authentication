...
class FirebaseAuthMethods{
  ...
  Future<void> signUpWithEmail({
    ...
    try {
      ...
      await sendEmailVerification(context);//---->for send email verification code in gmail
  ...
  Future<void> loginWithEmail({
    ...
    try {
      ...
      if (!user.emailVerified) {// -------------->email verified no hoy to faRiThi send kaRe
  ...
  Future<void> sendEmailVerification(BuildContext context) async {
    try {
      _auth.currentUser!.sendEmailVerification();//-------------->for Email verification sent
  ...
  Future<void> signInWithGoogle(BuildContext context) async {
    try {
      if (kIsWeb) {
        ...
        final GoogleSignInAuthentication? googleAuth = await googleUser?.authentication;//--------------->googleAuth variable ma store user

        if (googleAuth?.accessToken != null && googleAuth?.idToken != null) {//------------>check token
  ...
  Future<void> signInWithFacebook(BuildContext context) async {
    ...
    //------------>important------->
    //----------------------------->https://emn178.github.io/online-tools/base64_encode.html------>base 64 encode to hex--------->copy past Key Hashes
